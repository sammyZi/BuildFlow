                    ...
                    {models.map(model => (
                        ...
                        >
                            ...
                            {selectedModel === model.id && (
                                <Icons.Check className="w-4 h-4 text-blue-600 mt-1" />
                            )}
                        </button>
                    ))}
                </div>
...
export const ChatInput: React.FC<ChatInputProps> = ({ onSendMessage }) => {
    ...
    const models = [
        { id: "fast", name: "Fast Mode", description: "Quick, single-pass generation" },
        { id: "detailed", name: "Detailed Mode", description: "Iterative architectural planning", badge: "Pro" }
    ];
                                ...
                                <button
                                    ...
                                    className={`
                                        ...
                                        ${hasContent
                                            ...
                                            : 'bg-primary/30 text-white/60 cursor-default'}
                                    `}
                                    type="button"
